...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.quick_panel = QtWidgets.QWidget(self.layoutWidget)
        ...
        """)
        self.quick_panel_layout = QtWidgets.QVBoxLayout(self.quick_panel)
        self.quick_panel_layout.setContentsMargins(10, 8, 10, 8)
        self.quick_panel_layout.setSpacing(8)

        self.quick_title_layout = QtWidgets.QHBoxLayout()
        self.quick_title = QtWidgets.QLabel(self.quick_panel)
        self.quick_title.setObjectName("quickTitle")
        self.quick_status = QtWidgets.QLabel(self.quick_panel)
        self.quick_status.setObjectName("quickStatus")
        self.quick_status.setWordWrap(True)
        self.quick_title_layout.addWidget(self.quick_title)
        self.quick_title_layout.addStretch()
        self.quick_title_layout.addWidget(self.quick_status)
        self.quick_panel_layout.addLayout(self.quick_title_layout)

        self.quick_input_layout = QtWidgets.QHBoxLayout()
        self.quick_url = QtWidgets.QLineEdit(self.quick_panel)
        self.quick_url.setObjectName("quickUrl")
        self.quick_dubbing = QtWidgets.QCheckBox(self.quick_panel)
        self.quick_dubbing.setObjectName("quickDubbing")
        self.quick_delete_source = QtWidgets.QCheckBox(self.quick_panel)
        self.quick_delete_source.setObjectName("quickDeleteSource")
        self.quick_delete_source.setChecked(True)
        self.quick_help = QtWidgets.QPushButton(self.quick_panel)
        self.quick_help.setObjectName("quickHelp")
        self.quick_clear = QtWidgets.QPushButton(self.quick_panel)
        self.quick_clear.setObjectName("quickClear")
        self.quick_input_layout.addWidget(self.quick_url, 1)
        self.quick_input_layout.addWidget(self.quick_dubbing)
        self.quick_input_layout.addWidget(self.quick_delete_source)
        self.quick_input_layout.addWidget(self.quick_help)
        self.quick_input_layout.addWidget(self.quick_clear)
        self.quick_panel_layout.addLayout(self.quick_input_layout)
        self.verticalLayout_3.addWidget(self.quick_panel)
...
""")
    ...
    def _set_Ui_Text(self):
        ...
        self.quick_help.setText("Hướng dẫn")
        self.quick_help.setToolTip("Xem hướng dẫn dùng workflow dán link, dịch, chèn phụ đề và lồng tiếng.")
